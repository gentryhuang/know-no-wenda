...
public class CaptchaUtil {
    /**
     * CAPTCHA_CODES 是用来生成4位验证码的来源，
     * 但是这里使用到Algerian字体，系统里没有的话需要安装字体，字体只显示大写，为了清晰，就去掉了1,0,i,o几个容易混淆的字符
     */
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException{
        ...
        // 使用awt的BufferedImage对象，指定长和款以及RGB色彩值
